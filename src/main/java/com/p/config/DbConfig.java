...
public class DbConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		em.setPackagesToScan(new String[] { "com.p" });
	...
	public DataSource dataSource() {
		...
		dataSource.setUrl("jdbc:mysql://localhost:3306/pachanga");
	...
	Properties additionalProperties() {
		...
		properties.setProperty("hibernate.ejb.entitymanager_factory_name",
				"default");
